...
PILPhys<-read.csv("Drydown_gasexchange_pilularis.csv",sep=",", header=TRUE)
POPPhys<-read.csv("Drydown_gasexchange_populnea.csv",sep=",", header=TRUE)
...
PILPhysGraph<-read.csv("Pilularis_Phys.csv",sep=",", header=TRUE)
names(PILPhysGraph)
str(PILPhysGraph)
POPPhysGraph<-read.csv("Populnea_Phys.csv",sep=",", header=TRUE)
names(POPPhysGraph)
str(POPPhysGraph)
