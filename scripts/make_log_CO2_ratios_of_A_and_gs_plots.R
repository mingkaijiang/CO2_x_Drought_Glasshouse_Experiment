make_log_CO2_ratios_of_A_and_gs_plots <- function() {
    ...
    plotDF1$log_CO2_WUEdaily <- log(plotDF1$CO2_WUEdaily)
    plotDF1$log_CO2_WUEearly <- log(plotDF1$CO2_WUEearly)
    plotDF1$log_CO2_WUElate <- log(plotDF1$CO2_WUElate)
    
    plotDF2$log_CO2_WUEdaily <- log(plotDF2$CO2_WUEdaily)
    plotDF2$log_CO2_WUEearly <- log(plotDF2$CO2_WUEearly)
    plotDF2$log_CO2_WUElate <- log(plotDF2$CO2_WUElate)
    ...
    p7 <- ggplot(plotDF1, aes(x=Day, y=log_CO2_WUEdaily, group=Trt)) +
        geom_point(aes(col=Trt, fill=Trt), pch=21, size=2)+
        geom_line(aes(col=Trt))+
        geom_hline(yintercept=0, col="black", lty=2)+
        theme_linedraw() +
    ...
    p8 <- ggplot(plotDF1, aes(x=Day, y=log_CO2_WUEearly, group=Trt)) +
        geom_point(aes(col=Trt, fill=Trt), pch=21, size=2)+
        geom_line(aes(col=Trt))+
        geom_hline(yintercept=0, col="black", lty=2)+
        theme_linedraw() +
    ...
    p9 <- ggplot(plotDF1, aes(x=Day, y=log_CO2_WUElate, group=Trt)) +
        geom_point(aes(col=Trt, fill=Trt), pch=21, size=2)+
        geom_line(aes(col=Trt))+
        theme_linedraw() +
        geom_hline(yintercept=0, col="black", lty=2)+
    ...
    pdf(paste0(outdir, "F10.1.log_CO2_ratio_pilularis.pdf"), width=14, height=12)
    ...
    p7 <- ggplot(plotDF2, aes(x=Day, y=log_CO2_WUEdaily, group=Trt)) +
        geom_point(aes(col=Trt, fill=Trt), pch=21, size=2)+
        geom_line(aes(col=Trt))+
        theme_linedraw() +
        geom_hline(yintercept=0, col="black", lty=2)+
    ...
    p8 <- ggplot(plotDF2, aes(x=Day, y=log_CO2_WUEearly, group=Trt)) +
        geom_point(aes(col=Trt, fill=Trt), pch=21, size=2)+
        geom_line(aes(col=Trt))+
        theme_linedraw() +
        geom_hline(yintercept=0, col="black", lty=2)+
    ...
    p9 <- ggplot(plotDF2, aes(x=Day, y=log_CO2_WUElate, group=Trt)) +
        geom_point(aes(col=Trt, fill=Trt), pch=21, size=2)+
        geom_line(aes(col=Trt))+
        theme_linedraw() +
        geom_hline(yintercept=0, col="black", lty=2)+
    ...
    pdf(paste0(outdir, "F10.2.log_CO2_ratio_populnea.pdf"), width=14, height=12)
    plot_grid(combined_plots, combined_legend, 
              ncol=1, rel_heights=c(1, 0.1))
    dev.off() 
