make_populnea_physiological_plots <- function() {
    ...
    text(x=2, y=25, expression(bold("(a)")), cex=1.5)
    ...
    text(x=2, y=25, expression(bold("(b)")), cex=1.5)
    ...
    text(x=2, y=25, expression(bold("(c)")), cex=1.5)
    ...
    mtext(side = 2, text =expression(bold((mol~m^-2~s^-1))),
          font=2,cex=0.75, line = 2.25)	
    text(x=2, y=0.4, expression(bold("(d)")), cex=1.5)
    ...
    text(x=2, y=0.4, expression(bold("(e)")), cex=1.5)
