make_populnea_physiological_plots <- function() {
    ...
    pdf("output/F8.2.Pop_gas_exchange.pdf", width=8, height=6)
    #par(mfrow=c(2,3))
    ...
    #POP A Daily
    par(las=1)
    with(POPPhysGraph,plot(Adaily[Trt=="POPAD"]~Day[Trt=="POPAD"],col="red",pch=1,cex.axis=1.25,
    ...
    with(POPPhysGraph,points(Adaily[Trt=="POPAND"]~Day[Trt=="POPAND"],col="blue",pch=1,cex=1.25,type="o",lty=2))
    ...
    with(POPPhysGraph,points(Adaily[Trt=="POPED"]~Day[Trt=="POPED"],col="red",pch=16,cex=1.25,type="o"))
    with(POPPhysGraph,arrows(Day[Trt=="POPED"],
                             UAdaily[Trt=="POPED"], Day[Trt=="POPED"], LAdaily[Trt=="POPED"]
                             , length = .035, angle = 90, code = 3,col="red")) 
    with(POPPhysGraph,points(Adaily[Trt=="POPEND"]~Day[Trt=="POPEND"],col="blue",pch=16,cex=1.25,type="o"))
    ...
    #POP A Early
    par(las=1)
    with(POPPhysGraph,plot(Aearly[Trt=="POPAD"]~Day[Trt=="POPAD"],col="red",pch=1,
                           ylim=range(0,29),xlim=range(0,1.05*max(Day)),
    ...
    with(POPPhysGraph,arrows(Day[Trt=="POPAD"],
                             ...
                             , length = .035, angle = 90, code = 3,col="red"))        
    with(POPPhysGraph,points(Aearly[Trt=="POPAND"]~Day[Trt=="POPAND"],col="blue",pch=1,cex=1.25,type="o",lty=2))
    with(POPPhysGraph,arrows(Day[Trt=="POPAND"],
                             UAearly[Trt=="POPAND"], Day[Trt=="POPAND"], LAearly[Trt=="POPAND"]
                             , length = .035, angle = 90, code = 3,col="blue")) 
    with(POPPhysGraph,points(Aearly[Trt=="POPED"]~Day[Trt=="POPED"],col="red",pch=16,cex=1.25,type="o"))
    with(POPPhysGraph,arrows(Day[Trt=="POPED"],
                             UAearly[Trt=="POPED"], Day[Trt=="POPED"], LAearly[Trt=="POPED"]
                             , length = .035, angle = 90, code = 3,col="red")) 
    with(POPPhysGraph,points(Aearly[Trt=="POPEND"]~Day[Trt=="POPEND"],col="blue",pch=16,cex=1.25,type="o"))
    with(POPPhysGraph,arrows(Day[Trt=="POPEND"],
    ...
    #POP A Late
    par(las=1)
    with(POPPhysGraph,plot(Alate[Trt=="POPAD"]~Day[Trt=="POPAD"],col="red",pch=1,
    ...
    with(POPPhysGraph,arrows(Day[Trt=="POPAD"],
                             ...
                             , length = .035, angle = 90, code = 3,col="red"))        
    with(POPPhysGraph,points(Alate[Trt=="POPAND"]~Day[Trt=="POPAND"],col="blue",pch=1,cex=1.25,type="o",lty=2))
    with(POPPhysGraph,arrows(Day[Trt=="POPAND"],
                             UAlate[Trt=="POPAND"], Day[Trt=="POPAND"], LAlate[Trt=="POPAND"]
                             , length = .035, angle = 90, code = 3,col="blue")) 
    with(POPPhysGraph,points(Alate[Trt=="POPED"]~Day[Trt=="POPED"],col="red",pch=16,cex=1.25,type="o"))
    with(POPPhysGraph,arrows(Day[Trt=="POPED"],
                             UAlate[Trt=="POPED"], Day[Trt=="POPED"], LAlate[Trt=="POPED"]
                             , length = .035, angle = 90, code = 3,col="red")) 
    with(POPPhysGraph,points(Alate[Trt=="POPEND"]~Day[Trt=="POPEND"],col="blue",pch=16,cex=1.25,type="o"))
    with(POPPhysGraph,arrows(Day[Trt=="POPEND"],
    ...
    #POP GS Daily
    par(las=1)
    with(POPPhysGraph,plot(gsDaily[Trt=="POPAD"]~Day[Trt=="POPAD"],col="red",pch=1,cex=1.25,type="o",lty=2,cex.axis=1.25,
    ...
    with(POPPhysGraph,arrows(Day[Trt=="POPAD"],
                             ...
                             , length = .035, angle = 90, code = 3,col="red"))        
    with(POPPhysGraph,points(gsDaily[Trt=="POPAND"]~Day[Trt=="POPAND"],col="blue",pch=1,cex=1.25,type="o",lty=2))
    with(POPPhysGraph,arrows(Day[Trt=="POPAND"],
                             UgsDaily[Trt=="POPAND"], Day[Trt=="POPAND"], LgsDaily[Trt=="POPAND"]
                             , length = .035, angle = 90, code = 3,col="blue")) 
    with(POPPhysGraph,points(gsDaily[Trt=="POPED"]~Day[Trt=="POPED"],col="red",pch=16,cex=1.25,type="o"))
    with(POPPhysGraph,arrows(Day[Trt=="POPED"],
                             UgsDaily[Trt=="POPED"], Day[Trt=="POPED"], LgsDaily[Trt=="POPED"]
                             , length = .035, angle = 90, code = 3,col="red")) 
    with(POPPhysGraph,points(gsDaily[Trt=="POPEND"]~Day[Trt=="POPEND"],col="blue",pch=16,cex=1.25,type="o"))
    with(POPPhysGraph,arrows(Day[Trt=="POPEND"],
    ...
    #POP GS Early
    par(las=1)
    with(POPPhysGraph,plot(gsearly[Trt=="POPAD"]~Day[Trt=="POPAD"],col="red",pch=1,cex=1.25,type="o",lty=2,cex.axis=1.25,
    ...
    with(POPPhysGraph,arrows(Day[Trt=="POPAD"],
                             ...
                             , length = .035, angle = 90, code = 3,col="red"))        
    with(POPPhysGraph,points(gsearly[Trt=="POPAND"]~Day[Trt=="POPAND"],col="blue",pch=1,cex=1.25,type="o",lty=2))
    with(POPPhysGraph,arrows(Day[Trt=="POPAND"],
                             Ugsearly[Trt=="POPAND"], Day[Trt=="POPAND"], Lgsearly[Trt=="POPAND"]
                             , length = .035, angle = 90, code = 3,col="blue")) 
    with(POPPhysGraph,points(gsearly[Trt=="POPED"]~Day[Trt=="POPED"],col="red",pch=16,cex=1.25,type="o"))
    with(POPPhysGraph,arrows(Day[Trt=="POPED"],
                             Ugsearly[Trt=="POPED"], Day[Trt=="POPED"], Lgsearly[Trt=="POPED"]
                             , length = .035, angle = 90, code = 3,col="red")) 
    with(POPPhysGraph,points(gsearly[Trt=="POPEND"]~Day[Trt=="POPEND"],col="blue",pch=16,cex=1.25,type="o"))
    with(POPPhysGraph,arrows(Day[Trt=="POPEND"],
    ...
    #POP GS Late
    par(las=1)
    with(POPPhysGraph,plot(gslate[Trt=="POPAD"]~Day[Trt=="POPAD"],col="red",pch=1,cex=1.25,type="o",lty=2,cex.axis=1.25,
                           ylim=range(0,0.45),xlim=range(0,1.05*max(Day)),
                           yaxt="n",xlab=expression(bold(Day))))
    axis(2,labels=FALSE,tck=0.03)
    with(POPPhysGraph,arrows(Day[Trt=="POPAD"],
                             ...
                             , length = .035, angle = 90, code = 3,col="red"))        
    with(POPPhysGraph,points(gslate[Trt=="POPAND"]~Day[Trt=="POPAND"],col="blue",pch=1,cex=1.25,type="o",lty=2))
    with(POPPhysGraph,arrows(Day[Trt=="POPAND"],
                             Ugslate[Trt=="POPAND"], Day[Trt=="POPAND"], Lgslate[Trt=="POPAND"]
                             , length = .035, angle = 90, code = 3,col="blue")) 
    with(POPPhysGraph,points(gslate[Trt=="POPED"]~Day[Trt=="POPED"],col="red",pch=16,cex=1.25,type="o"))
    with(POPPhysGraph,arrows(Day[Trt=="POPED"],
                             Ugslate[Trt=="POPED"], Day[Trt=="POPED"], Lgslate[Trt=="POPED"]
                             , length = .035, angle = 90, code = 3,col="red")) 
    with(POPPhysGraph,points(gslate[Trt=="POPEND"]~Day[Trt=="POPEND"],col="blue",pch=16,cex=1.25,type="o"))
    with(POPPhysGraph,arrows(Day[Trt=="POPEND"],
