make_pilularis_physiological_plots <- function() {
    ...
    pdf("output/F8.1.Pil_gas_exchange.pdf", width=8, height=6)
    #par(mfrow=c(2,3))
    ...
    #PIL A Daily
    par(las=1)
    with(PILPhysGraph,plot(Adaily[Trt=="PILAD"]~Day[Trt=="PILAD"],col="red",pch=1,cex.axis=1.25,
    ...
    with(PILPhysGraph,points(Adaily[Trt=="PILAND"]~Day[Trt=="PILAND"],col="blue",pch=1,cex=1.25,type="o", lty=2))
    ...
    with(PILPhysGraph,points(Adaily[Trt=="PILED"]~Day[Trt=="PILED"],col="red",pch=16,cex=1.25,type="o",lty=1))
    with(PILPhysGraph,arrows(Day[Trt=="PILED"],
                             UAdaily[Trt=="PILED"], Day[Trt=="PILED"], LAdaily[Trt=="PILED"]
                             , length = .035, angle = 90, code = 3,col="red")) 
    with(PILPhysGraph,points(Adaily[Trt=="PILEND"]~Day[Trt=="PILEND"],col="blue",pch=16,cex=1.25,type="o"))
    ...
    #PIL A Early
    par(las=1)
    with(PILPhysGraph,plot(Aearly[Trt=="PILAD"]~Day[Trt=="PILAD"],col="red",pch=1,
                           ylim=range(0,29),xlim=range(0,1.05*max(Day)),
    ...
    with(PILPhysGraph,arrows(Day[Trt=="PILAD"],
                             ...
                             , length = .035, angle = 90, code = 3,col="red"))        
    with(PILPhysGraph,points(Aearly[Trt=="PILAND"]~Day[Trt=="PILAND"],col="blue",pch=1,cex=1.25,type="o", lty=2))
    with(PILPhysGraph,arrows(Day[Trt=="PILAND"],
                             UAearly[Trt=="PILAND"], Day[Trt=="PILAND"], LAearly[Trt=="PILAND"]
                             , length = .035, angle = 90, code = 3,col="blue")) 
    with(PILPhysGraph,points(Aearly[Trt=="PILED"]~Day[Trt=="PILED"],col="red",pch=16,cex=1.25,type="o"))
    with(PILPhysGraph,arrows(Day[Trt=="PILED"],
                             UAearly[Trt=="PILED"], Day[Trt=="PILED"], LAearly[Trt=="PILED"]
                             , length = .035, angle = 90, code = 3,col="red")) 
    with(PILPhysGraph,points(Aearly[Trt=="PILEND"]~Day[Trt=="PILEND"],col="blue",pch=16,cex=1.25,type="o"))
    with(PILPhysGraph,arrows(Day[Trt=="PILEND"],
    ...
    #PIL A Late
    par(las=1)
    with(PILPhysGraph,plot(Alate[Trt=="PILAD"]~Day[Trt=="PILAD"],col="red",pch=1,
    ...
    with(PILPhysGraph,arrows(Day[Trt=="PILAD"],
                             ...
                             , length = .035, angle = 90, code = 3,col="red"))        
    with(PILPhysGraph,points(Alate[Trt=="PILAND"]~Day[Trt=="PILAND"],col="blue",pch=1,cex=1.25,type="o",lty=2))
    with(PILPhysGraph,arrows(Day[Trt=="PILAND"],
                             UAlate[Trt=="PILAND"], Day[Trt=="PILAND"], LAlate[Trt=="PILAND"]
                             , length = .035, angle = 90, code = 3,col="blue")) 
    with(PILPhysGraph,points(Alate[Trt=="PILED"]~Day[Trt=="PILED"],col="red",pch=16,cex=1.25,type="o"))
    with(PILPhysGraph,arrows(Day[Trt=="PILED"],
                             UAlate[Trt=="PILED"], Day[Trt=="PILED"], LAlate[Trt=="PILED"]
                             , length = .035, angle = 90, code = 3,col="red")) 
    with(PILPhysGraph,points(Alate[Trt=="PILEND"]~Day[Trt=="PILEND"],col="blue",pch=16,cex=1.25,type="o"))
    with(PILPhysGraph,arrows(Day[Trt=="PILEND"],
                             UAlate[Trt=="PILEND"], Day[Trt=="PILEND"], LAlate[Trt=="PILEND"]
                             , length = .035, angle = 90, code = 3,col="blue")) 
    legend("topleft",  expression(aC[a]~-~W, aC[a]~-~D,eC[a]~-~W ,eC[a]~-~D),
           cex=1.35,bty="n",
           pch = c(1,1,16,16),lty=c(2,2,1,1), col=c("blue","red","blue","red"))
    mtext(side=3,text="Midday",line=0.5,font=1,cex=1.0)
    text(8.25,27.75, "(c)", pos=4,cex=1,font=2)
    
    #PIL GS Daily
    par(las=1)
    with(PILPhysGraph,plot(gsDaily[Trt=="PILAD"]~Day[Trt=="PILAD"],col="red",pch=1,cex=1.25,type="o",lty=2,cex.axis=1.25,
    ...
    with(PILPhysGraph,arrows(Day[Trt=="PILAD"],
                             ...
                             , length = .035, angle = 90, code = 3,col="red"))        
    with(PILPhysGraph,points(gsDaily[Trt=="PILAND"]~Day[Trt=="PILAND"],col="blue",pch=16,cex=1.25,type="o",lty=2))
    with(PILPhysGraph,arrows(Day[Trt=="PILAND"],
                             UgsDaily[Trt=="PILAND"], Day[Trt=="PILAND"], LgsDaily[Trt=="PILAND"]
                             , length = .035, angle = 90, code = 3,col="blue")) 
    with(PILPhysGraph,points(gsDaily[Trt=="PILED"]~Day[Trt=="PILED"],col="red",pch=16,cex=1.25,type="o"))
    with(PILPhysGraph,arrows(Day[Trt=="PILED"],
                             UgsDaily[Trt=="PILED"], Day[Trt=="PILED"], LgsDaily[Trt=="PILED"]
                             , length = .035, angle = 90, code = 3,col="red")) 
    with(PILPhysGraph,points(gsDaily[Trt=="PILEND"]~Day[Trt=="PILEND"],col="blue",pch=16,cex=1.25,type="o"))
    with(PILPhysGraph,arrows(Day[Trt=="PILEND"],
    ...
    #PIL GS Early
    par(las=1)
    with(PILPhysGraph,plot(gsearly[Trt=="PILAD"]~Day[Trt=="PILAD"],col="red",pch=1,cex=1.25,type="o",lty=2,cex.axis=1.25,
    ...
    with(PILPhysGraph,arrows(Day[Trt=="PILAD"],
                             ...
                             , length = .035, angle = 90, code = 3,col="red"))        
    with(PILPhysGraph,points(gsearly[Trt=="PILAND"]~Day[Trt=="PILAND"],col="blue",pch=1,cex=1.25,type="o",lty=2))
    with(PILPhysGraph,arrows(Day[Trt=="PILAND"],
                             Ugsearly[Trt=="PILAND"], Day[Trt=="PILAND"], Lgsearly[Trt=="PILAND"]
                             , length = .035, angle = 90, code = 3,col="blue")) 
    with(PILPhysGraph,points(gsearly[Trt=="PILED"]~Day[Trt=="PILED"],col="red",pch=16,cex=1.25,type="o",lty=1))
    with(PILPhysGraph,arrows(Day[Trt=="PILED"],
                             Ugsearly[Trt=="PILED"], Day[Trt=="PILED"], Lgsearly[Trt=="PILED"]
                             , length = .035, angle = 90, code = 3,col="red")) 
    with(PILPhysGraph,points(gsearly[Trt=="PILEND"]~Day[Trt=="PILEND"],col="blue",pch=16,cex=1.25,type="o"))
    with(PILPhysGraph,arrows(Day[Trt=="PILEND"],
    ...
    #PIL GS Late
    par(las=1)
    with(PILPhysGraph,plot(gslate[Trt=="PILAD"]~Day[Trt=="PILAD"],col="red",pch=1,cex=1.25,type="o",lty=2,cex.axis=1.25,
                           ylim=range(0,0.45),xlim=range(0,1.05*max(Day)),
                           yaxt="n",xlab=expression(bold(Day))))
    axis(2,labels=FALSE,tck=0.03)
    with(PILPhysGraph,arrows(Day[Trt=="PILAD"],
                             ...
                             , length = .035, angle = 90, code = 3,col="red"))        
    with(PILPhysGraph,points(gslate[Trt=="PILAND"]~Day[Trt=="PILAND"],col="blue",pch=1,cex=1.25,type="o",lty=2))
    with(PILPhysGraph,arrows(Day[Trt=="PILAND"],
                             Ugslate[Trt=="PILAND"], Day[Trt=="PILAND"], Lgslate[Trt=="PILAND"]
                             , length = .035, angle = 90, code = 3,col="blue")) 
    with(PILPhysGraph,points(gslate[Trt=="PILED"]~Day[Trt=="PILED"],col="red",pch=16,cex=1.25,type="o",lty=2))
    with(PILPhysGraph,arrows(Day[Trt=="PILED"],
                             Ugslate[Trt=="PILED"], Day[Trt=="PILED"], Lgslate[Trt=="PILED"]
                             , length = .035, angle = 90, code = 3,col="red")) 
    with(PILPhysGraph,points(gslate[Trt=="PILEND"]~Day[Trt=="PILEND"],col="blue",pch=16,cex=1.25,type="o"))
    with(PILPhysGraph,arrows(Day[Trt=="PILEND"],
