setwd("")
PilTLA<-read.csv("PILtransp_leafarea.csv",sep=",", header=TRUE)
PopTLA<-read.csv("POPtransp_leafarea.csv",sep=",", header=TRUE)
...
with(PilTLA,points(transp_plant[Trt=="PILAND"]~leaf_area[Trt=="PILAND"],col="blue",pch=16,cex=1.25))

with(PilTLA,points(transp_plant[Trt=="PILED"]~leaf_area[Trt=="PILED"],col="red",pch=1,lty=2,cex=1.25))

with(PilTLA,points(transp_plant[Trt=="PILEND"]~leaf_area[Trt=="PILEND"],col="red",pch=16,cex=1.25))
...
with(PopTLA,points(transp_plant[Trt=="POPAND"]~leaf_area[Trt=="POPAND"],col="blue",pch=16,cex=1.25))

with(PopTLA,points(transp_plant[Trt=="POPED"]~leaf_area[Trt=="POPED"],col="red",pch=1,lty=2,cex=1.25))

with(PopTLA,points(transp_plant[Trt=="POPEND"]~leaf_area[Trt=="POPEND"],col="red",pch=16,cex=1.25))
